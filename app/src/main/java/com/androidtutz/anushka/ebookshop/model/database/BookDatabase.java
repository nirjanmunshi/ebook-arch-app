package com.androidtutz.anushka.ebookshop.model.database;
...
public abstract class BookDatabase extends RoomDatabase {
    public static BookDatabase mInstance;
    private static RoomDatabase.Callback callback = new Callback() {
        @Override
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            super.onCreate(db);
            new InitialDataAsyncTask(mInstance).execute();
        }
    };

    public static synchronized BookDatabase getInstance(Context context) {
        if (mInstance == null) {
            mInstance = Room.databaseBuilder(context.getApplicationContext(), BookDatabase.class, "book_database")
    ...
    private static class InitialDataAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        InitialDataAsyncTask(BookDatabase bookDatabase) {
